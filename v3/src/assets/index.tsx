...
export const experienceData: ExperienceDataModel[] = [
  ...
  },
  {
    ...
    details: [
      "Developed web and mobile applications for managing and tracking customer support cases.",
      "Built full-stack solutions using Node.js, React, Vue.js, TypeScript, Tailwind CSS and AWS.",
      "Integrated applications with Microsoft Dynamics 365 / Dataverse, including custom CRM functionality and plugins.",
      "Developed solutions for enterprise customers including Ford Motor Company, contributing across architecture, APIs, frontend development and third-party integrations.",
    ],
    experience: [],
  },
  {
